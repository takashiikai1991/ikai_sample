...
double trig_kWOS[4][2]={0};// mean,stat,sts,err * lowpt,highpt
double trig_kWSS[4][2]={0};
double trig_rQCD[4][2]={0};
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!  
...
trig_rQCD[0][0] = set_rQCD("mean",req_period,req_prongs,req_ETA,req_ID ,1,25);
trig_kWOS[0][0] = set_kW  ("mean",req_period,req_prongs,req_ETA,req_ID ,"OS",1,25);
trig_kWSS[0][0] = set_kW  ("mean",req_period,req_prongs,req_ETA,req_ID ,"SS",1,25);
trig_rQCD[0][1] = set_rQCD("mean",req_period,req_prongs,req_ETA,req_ID ,2,25);
trig_kWOS[0][1] = set_kW  ("mean",req_period,req_prongs,req_ETA,req_ID ,"OS",2,25);
trig_kWSS[0][1] = set_kW  ("mean",req_period,req_prongs,req_ETA,req_ID ,"SS",2,25);

trig_rQCD[2][0] = set_rQCD("err",req_period,req_prongs,req_ETA,req_ID ,1,25);
trig_kWOS[2][0] = set_kW  ("err",req_period,req_prongs,req_ETA,req_ID ,"OS",1,25);
trig_kWSS[2][0] = set_kW  ("err",req_period,req_prongs,req_ETA,req_ID ,"SS",1,25);
trig_rQCD[2][1] = set_rQCD("err",req_period,req_prongs,req_ETA,req_ID ,2,25);
trig_kWOS[2][1] = set_kW  ("err",req_period,req_prongs,req_ETA,req_ID ,"OS",2,25);
trig_kWSS[2][1] = set_kW  ("err",req_period,req_prongs,req_ETA,req_ID ,"SS",2,25);
