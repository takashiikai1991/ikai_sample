...
void Bin13Another(TString req_period = "all",int req_prongs =0,int req_ETA=0,int req_ID=2
		  ,int  b_trig=0
...
#include "selection.h"    
  ...
  TH1D* h_data_SSbin[13];//=new TH1D("h_data_SS2","h_data_SS2" ,hist_Xbin,hist_Xbegin , hist_Xend);    
  for(short jj=0; jj<13; jj++ ){
