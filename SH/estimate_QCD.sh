...
do
  ...
  #  root "QCD2.C+( \"${period}\" ,${i_prong} , ${s_eta} , ${s_tauID} , ${trig} ,\"tau_0_leadTrk_z0-lep_0_trk_z0\", 25,-1.5,1.5 , ${s_pt} )" -l -b -q 
    ...
    root "QCD2.C+( \"${period}\" ,${i_prong} , ${s_eta} , ${s_tauID} , ${trig} ,\"lep_0_pt\", 20,20,70 , ${s_pt} )" -l -b -q
   ...
   # continue;
	...
	# root "QCD2.C+( \"${period}\" ,${i_prong} , ${s_eta} , ${s_tauID} , ${trig} ,\"lep_0_iso_topoetcone20\", 60,-0.1,0.5 , ${s_pt} )" -l -b -q
     ...
     # root "QCD2.C+( \"${period}\" ,${i_prong} , ${s_eta} , ${s_tauID} , ${trig} ,\"lep_0_iso_etcone40\", 60,-0.1.,0.5 , ${s_pt} )" -l -b -q    
    	...
    	# # # # kinematic
    root "QCD2.C+( \"${period}\" ,${i_prong} , ${s_eta} , ${s_tauID} , ${trig} ,\"lephad_vis_mass\", 20,0,200 , ${s_pt} )" -l -b -q      		    
    root "QCD2.C+( \"${period}\" ,${i_prong} , ${s_eta} , ${s_tauID} , ${trig} ,\"lephad_met_sum_cos_dphi\", 20,-1.5,1.5 , ${s_pt} )" -l -b -q
    root "QCD2.C+( \"${period}\" ,${i_prong} , ${s_eta} , ${s_tauID} , ${trig} ,\"lephad_mt_lep0_met\", 15,0, 60 , ${s_pt} )" -l -b -q	
...
do	
    ...
    if test ${i_prong} -eq 1 ;then                                                                                                                                                                                                     
    	...
    	root "QCD2.C+( \"${period}\" ,${i_prong} , ${s_eta} , ${s_tauID} , ${trig} ,\"tau_0_id_SumPtTrkFracCorrected\", 20,-0.002,0.018 , ${s_pt} )" -l -b -q #1p
    fi    
    ...
    if test ${i_prong} -eq 1 ;then                                                                                                                                                                                                     
    	echo 1p                                                                                                                                                                                                                        
    	root "QCD2.C+( \"${period}\" ,${i_prong} , ${s_eta} , ${s_tauID} , ${trig} ,\"tau_0_id_ipSigLeadTrk\", 20,-0,15 , ${s_pt} )" -l -b -q  #1p
    	root "QCD2.C+( \"${period}\" ,${i_prong} , ${s_eta} , ${s_tauID} , ${trig} ,\"tau_0_id_SumPtTrkFrac\", 20,-0.002,0.018 , ${s_pt} )" -l -b -q #1p
    fi    
